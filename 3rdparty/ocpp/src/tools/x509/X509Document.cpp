...
X509Document::X509Document(const std::experimental::filesystem::path& pem_file) : m_is_valid(false), m_pem(), m_openssl_object(nullptr)
{
    // Open PEM file
...
bool X509Document::toFile(const std::experimental::filesystem::path& pem_file) const
{
    bool         ret = false;
