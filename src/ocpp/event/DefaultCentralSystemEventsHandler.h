#ifndef OS_DEFAULT_CENTRAL_SYSTEM_EVENTS_HANDLER_H
#define OS_DEFAULT_CENTRAL_SYSTEM_EVENTS_HANDLER_H
...
class DefaultCentralSystemEventsHandler : public ::ocpp::centralsystem::ocpp20::ICentralSystemEventsHandler20
{
  public:
    /** @brief Constructor */
    DefaultCentralSystemEventsHandler(os::ocpp::CentralSystemDemoConfig&            config,
                                      std::experimental::filesystem::path iso_v2g_root_ca    = "",
    ...
    std::experimental::filesystem::path& v2gRootCA() { return m_iso_v2g_root_ca; }
    /** @brief Path to the MO root CA */
    std::experimental::filesystem::path& moRootCA() { return m_iso_mo_root_ca; }
  ...
  protected:
    ...
    /** @brief Path to the V2G root CA */
    std::experimental::filesystem::path m_iso_v2g_root_ca;
    /** @brief Path to the MO root CA */
    std::experimental::filesystem::path m_iso_mo_root_ca;
    /** @brief Indicate if the charge point must be set on pending status upon connection */
...
#endif // OS_DEFAULT_CENTRAL_SYSTEM_EVENTS_HANDLER_H
